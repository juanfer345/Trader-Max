...
public class PanelMostrarHistorial extends JPanel{
	...
	public void asignarOyente() {
		...
		if (InicializacionAplicacion.usuarioActivo.getMenuDeConsola().buscarOpcionDeMenu(new ControlBorrarHistorial())) {
			boton_borrar.addActionListener(new ControlBorrarHistorial());
		}
	}
}