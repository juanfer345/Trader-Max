...
//		tipoDeCuenta = ErrorAplicacion.controlByte((byte) 1, (byte) 3, sb.toString(), "Por favor ingrese un número entero");
...
//			nombreIngresado = ErrorAplicacion.controlString("Nombre", "Ha ingresado un número en lugar de texto");
//			if (controlError) {System.out.println(); return;}
//
//			// Control de ingreso de cedula
//			cedulaIngresada = ErrorAplicacion.controlEntero(1, Integer.MAX_VALUE, "Cédula", "Por favor ingrese una cédula válida");
//			if (controlError) {System.out.println(); return;}
//
...
//			if (!ErrorAplicacion.controlContrasena(contrasenaIngresada)) {System.out.println(); return;}
//
