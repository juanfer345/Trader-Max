...
//		nombre = ErrorAplicacion.controlString("Nombre", "Se está ingresando un número en lugar de un nombre");
//		if (controlError) {System.out.println(); return;}
//
//		//Ingreso del precio del producto
//		precio = ErrorAplicacion.controlReal(0.1, Double.MAX_VALUE, "Precio", "Por favor ingrese un número real");
//		if (controlError) {System.out.println(); return;}
//
//		//Ingreso de la cantidad del producto
//		cant = ErrorAplicacion.controlEntero(1, Integer.MAX_VALUE, "Cantidad", "Por favor ingrese un número entero positivo");
//		if (controlError) {System.out.println(); return;}
//
//		//Ingreso de la categoría
//		categoria = ErrorAplicacion.controlByte((byte) 1, (byte) Producto.categorias.length, sb.toString(), "Por favor ingrese un número entero");
//		if (controlError) {System.out.println(); return;}
//
