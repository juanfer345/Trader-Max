...
public class AgregarOpcion extends OpcionDeMenu {
	...
	public void ejecutar() throws NumberFormatException, IOException {
		...
		System.out.println(usuario.getMenuDeConsola().comprobarCantidadOpciones(idUsuario, tipoUsuario, (byte) 1));
		...
		while (!controlError) {
			...
			if(opcionUsuario!=0) {
				if (opcionUsuario != -1) {
					System.out.println(usuario.getMenuDeConsola().agregarOpcion(idUsuario, tipoUsuario,
							(byte) (opcionUsuario - 1)));
				}
				else {
					System.out.println("El identificador de usuario debe ser un número entero.");
				}
