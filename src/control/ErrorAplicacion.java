...
public abstract class ErrorAplicacion extends Exception {
	...
	public static String controlString(String entrada, String Error) throws IOException {
	...
	public static String controlCorreo(String entrada) throws IOException {
		...
		if (comprobacion == -1) {
			...
			if (ingresoCorrecto) {
				...
				throw new IOException("Ingresar un correo válido de la forma: 'ejemplo@dirección.com'.");
			}
		} else {
